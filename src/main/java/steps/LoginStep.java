...
public class LoginStep {
    ...
    public void userClickOnProvidedUrl()
    {
    }
    ...
    @Then("User should click on Dropdown arrow")
    public void userShouldClickOnDropdownArrow() {
    }

    @Given("user launch url {string}")
    public void userLaunchUrl(String url)
    {
    ...
    @Then("user enter valid username and password and perform click")
    public void userEnterValidUsernameAndPasswordAndPerformClick(String uname,String pass)
    {
      driver.findElement(By.xpath("//input[@placeholder=\"Username\"]")).sendKeys("test170423@yopmail.com");
